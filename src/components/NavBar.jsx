...
const NavBar = () => {
    ...
    return (
        <nav className={`navbar navbar-expand-lg fixed-top ${navbar ? styles.bgDark : styles.bgTransparent}`}>
                    ...
                    <ul className="navbar-nav ms-auto">
                        ...
                        <li className="nav-item">
                            <button onClick={changeTheme} className="btn rounded-fill">
                                <i id="dl-icon" className={theme === 'dark' ? 'bi bi-sun-fill' : 'bi bi-moon-fill'}></i>
                            </button>
                        </li>
                    </ul>
                </div>
